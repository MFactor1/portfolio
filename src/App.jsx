...
import EntryAnim from './components/EntryAnimation'
        ...
        <main className="bodypages" style={{ marginLeft: isMobile ? "0px" : "20px" }}>
          <AnimatePresence mode="wait">
            <Routes location={location} key={location.pathname}>
              <Route path="/" element={<EntryAnim><Home /></EntryAnim>} />
              <Route path="/experience" element={<EntryAnim><Experience /></EntryAnim>} />
              <Route path="/projects" element={<EntryAnim><Projects /></EntryAnim>} />
              <Route path="/skills" element={<EntryAnim><Skills /></EntryAnim>} />
              <Route path="/readings" element={<EntryAnim><Readings /></EntryAnim>} />
            </Routes>
          </AnimatePresence>
        </main>
        <EntryAnim>
